...
function test()
{
    ...
    if ($tama1->getHappiness()==50 && $tama1->getHungriness()==50 && $tama1->getFullness()==50 && $tama1->getTiredness() == 50)
    {
    ...
    $tama3->feed();
    if ($tama3->getHappiness()==50 && $tama3->getHungriness()==20 && $tama3->getFullness()==100 && $tama3->getTiredness() == 100)
    {
    ...
    $tama4->feed();
    if ($tama4->getHappiness()==50 && $tama4->getHungriness()==1 && $tama4->getFullness()==80 && $tama4->getTiredness() == 100)
    {
    ...
    $tama5->play();
    if ($tama5->getHappiness()==100 && $tama5->getHungriness()==50 && $tama5->getFullness()==50 && $tama5->getTiredness() == 80)
    {
    ...
    $tama6->play();
    if ($tama6->getHappiness()==80 && $tama6->getHungriness()==50 && $tama6->getFullness()==50 && $tama6->getTiredness() == 100)
    {
    ...
    $tama7->putToBed();
    if ($tama7->getHappiness()==50 && $tama7->getHungriness()==50 && $tama7->getFullness()==50 && $tama7->getTiredness() == 1)
    {
    ...
    $tama8->poop();
    if ($tama8->getHappiness()==50 && $tama8->getHungriness()==50 && $tama8->getFullness()==1 && $tama8->getTiredness() == 50)
    {
    ...
    $tama9->timeEffect();
    if ($tama9->getHappiness()==49 && $tama9->getHungriness()==51 && $tama9->getFullness()==50 && $tama9->getTiredness() == 51)
    {
